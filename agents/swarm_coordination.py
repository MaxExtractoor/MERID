...
class ConflictResolver:
    ...
    def resolve(
        ...
        if self.strategy == ConflictResolution.HIGHEST_CONFIDENCE:
            ...
            return self._governance_decision(decisions, context)
    ...
    def _governance_decision(
        ...
        try:
            result = gov_agent.make_decision({
...
class SwarmCoordinator:
    ...
    def coordinate_decision(
        ...
        # Collect votes
        votes = self._voting.collect_votes(agents, question, context)
    ...
    def consult_experts(
        ...
        opinions = panel.consult_experts(question, context)
    ...
    def resolve_conflict(
        ...
        """Resolve conflicting decisions."""
        return self._conflict_resolver.resolve(decisions, context)
