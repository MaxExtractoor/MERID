"""
Agent Mesh - Manages all streaming agents as continuous async tasks.

This is the production agent orchestration layer.
All agents run autonomously, not on-demand.
