...
class PerformanceAnalytics:
    ...
    def calculate_agent_metrics(
        ...
        if resolved:
            ...
            # Precision and recall (treating "accept" as positive class)
            true_positives = sum(
                1 for r in resolved
        ...
        if reflections:
            ...
            if resolved:
                ...
                if high_conf_reflections:
                    ...
                    # Calibration: how close is high confidence accuracy to expected
                ...
                # Underconfidence: low confidence but correct
