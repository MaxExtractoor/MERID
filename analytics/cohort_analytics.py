...
# ZT10-01: Use a named module logger — never mutate the root logger at import time.
logger = get_logger("analytics.cohort_analytics")
# Scoped file handler for persistent analytics output (UTF-8, append).
...
logger.addHandler(_file_handler)  # type: ignore[union-attr]
