...
_STOP_WORDS = frozenset({
    ...
    "they", "them", "their", "there", "when", "what", "which", "while",
    "also", "into", "then", "than", "more", "some", "such", "none",
    "each", "very", "just", "over", "after", "before", "about", "would",
    "could", "should", "other", "these", "those", "only", "both",
})
