...
DEFAULT_CHAINLINK_FEEDS: List[ChainlinkFeed] = [
    ...
    ChainlinkFeed(slug="pol-usd", category="crypto-usd", name="POL/USD", scale_hint=0.5),
...
class PolymarketClient:
    ...
    def __init__(self, *, timeout: float = 10.0, use_mock: bool = False) -> None:
        ...
        self.use_mock = use_mock or os.getenv("MERID_POLYMARKET_MOCK", "").lower() in ("1", "true", "yes")
        self._client = httpx.Client(timeout=timeout)
