...
# ZT2-04: DEPRECATED — use trading.trade_mode.TradeMode instead.
# Alias kept for backward compatibility. SIMULATION → MOCK.
...
class AgentHeartbeat:
    ...
    # Mode
    current_mode: TradingMode = TradingMode.MOCK
