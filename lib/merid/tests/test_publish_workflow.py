...
def test_publish_workflow_has_sbom_and_cosign_and_attach():
    ...
    assert "attach SBOM" in text.lower() or "sbom" in text, "Publish workflow should attach SBOM to release (when available)"
