...
def test_place_order_success():
    ...
    r = place_order(o, idempotency_key="k1")
...
def test_place_order_idempotency():
    ...
    r1 = place_order(o, idempotency_key="abc")
    r2 = place_order(o, idempotency_key="abc")
    assert r1["id"] == r2["id"]


def test_place_order_fails_bad_quantity():
    with pytest.raises(ExecutionError):
        place_order({"symbol": "X", "side": "buy", "quantity": -5}, idempotency_key=None)
