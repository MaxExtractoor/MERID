...
Env vars:
    MERID_COINBASE_API_KEY    / COINBASE_API_KEY
    MERID_COINBASE_API_SECRET / COINBASE_API_SECRET
"""
...
class CoinbaseAdvancedAdapter(VenueAdapter):
    ...
    def __init__(
        ...
        self.api_key = (
            api_key
            or os.getenv("MERID_COINBASE_API_KEY")
            or os.getenv("COINBASE_API_KEY")
        )
        self.api_secret = (
            api_secret
            or os.getenv("MERID_COINBASE_API_SECRET")
