...
class DecisionLog:
    ...
    def _trim(self, lst: list) -> list:
        ...
        if len(lst) > self._MAX_LIST:
            return lst[-self._TRIM_TO:]
        return lst

    def log_trade_execution(self, trade: TradeExecution) -> None:
        """Log a trade execution."""
        self._trade_executions.append(trade)
        self._trade_executions = self._trim(self._trade_executions)
    ...
    def log_quote_snapshot(self, quote: QuoteSnapshot) -> None:
        ...
        self._quote_snapshots = self._trim(self._quote_snapshots)
    ...
    def log_position_change(self, position: PositionChange) -> None:
        ...
        self._position_changes = self._trim(self._position_changes)
    ...
    def log_agent_decision(self, decision: AgentDecision) -> None:
        ...
        self._agent_decisions = self._trim(self._agent_decisions)
    ...
    def log_outcome_validation(self, validation: OutcomeValidation) -> None:
        ...
        self._outcome_validations = self._trim(self._outcome_validations)
    ...
    def log_market_context(self, context: MarketContext) -> None:
        ...
        self._market_contexts = self._trim(self._market_contexts)
