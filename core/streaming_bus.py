...
def get_streaming_bus() -> StreamingBus:
    """Alias for get_event_bus — used by execution_subscriber."""
    return streaming_bus
...
# Named-subscriber convenience methods (do NOT overwrite core subscribe/unsubscribe)
StreamingBus.subscribe_named = lambda self, subscriber_id, channels, queue_size=100: subscribe_by_id(subscriber_id, channels, queue_size)
StreamingBus.unsubscribe_named = lambda self, subscriber_id: unsubscribe_by_id(subscriber_id)
