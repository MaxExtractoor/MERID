...
class TradingMode(Enum):
    """System operational modes (feature gating, NOT trade execution).

    ZT2-03: This enum is for system-level feature gating only.
    For trade execution mode, use ``trading.trade_mode.TradeMode``.
    """
    OFFLINE = "offline"
