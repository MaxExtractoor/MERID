...
class CanaryRelease:
    ...
    async def _collect_metrics(self, stage: RolloutStage, percentage: float) -> RolloutMetrics:
        ...
        request_count = int(1000 * (percentage / 100))
        success_count = int(request_count * 0.98)
        ...
        return RolloutMetrics(
            ...
            average_latency_ms=random.uniform(50, 200),
            p95_latency_ms=random.uniform(200, 500),
