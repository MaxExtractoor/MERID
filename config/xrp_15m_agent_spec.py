"""
XRP 15m Agent Spec — regime-aware XRP 15m Kalshi up/down contracts.
"""
...
@dataclass
class Xrp15mInputs:
    """Inputs needed for XRP 15m decision."""
...
def should_trade_xrp_15m(
    inputs: Xrp15mInputs,
    params: Xrp15mParams,
) -> Optional[Xrp15mSignal]:
    """
    Decide whether to take an XRP 15m position, mirroring BTC 15m logic.
    """
    # Time window guard.
    if not (
