"""
DOGE 15m Agent Spec — regime-aware DOGE 15m Kalshi up/down contracts.
"""
...
@dataclass
class Doge15mInputs:
    """Inputs needed for DOGE 15m decision."""
...
@dataclass
class Doge15mParams:
    """Configurable DOGE 15m parameters (config-only tuning)."""
...
def should_trade_doge_15m(
    inputs: Doge15mInputs,
    params: Doge15mParams,
) -> Optional[Doge15mSignal]:
    """
    Decide whether to take a DOGE 15m position, mirroring XRP/BTC 15m logic.
    """
    # Time window guard.
    if not (
