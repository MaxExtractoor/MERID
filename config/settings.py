"""T-060: DEPRECATED — use merid.settings instead.

This module is kept for backward compatibility only.
All new code should import from merid.settings.
"""
...
warnings.warn(
    "config.settings is deprecated — use merid.settings instead (T-060)",
    DeprecationWarning,
    stacklevel=2,
)
