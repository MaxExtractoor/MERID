...
class BtcAnchorGate:
    ...
    LEAD_LAG_SECONDS = 60
    IMPULSE_MIN_PCT = 0.3
    HISTORY_WINDOW = 100  # Number of regime states to keep in history
    ...
    def __init__(self):
        ...
        self._last_regime: Optional[BtcRegimeState] = None
        self._regime_history: deque = deque(maxlen=self.HISTORY_WINDOW)
