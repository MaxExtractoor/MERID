...
DEPRECATION NOTICE:
====================
This module is deprecated and should only be used for reference and testing.
The canonical single source of truth for Kalshi risk configuration is:
    merid.event_venues.kalshi.kalshi_risk.KalshiRiskConfig

The PM-specific KalshiRiskConfig in this file is deprecated. Live trading code
should use the venue config from:
...
# DEPRECATED: This KalshiRiskConfig is legacy and has been consolidated into
# merid/event_venues/kalshi/kalshi_risk.py. Use that version as the canonical source.
# This file is kept in archive/legacy for reference only.
...
class KalshiRiskConfig:
    ...
    DEPRECATED: Use merid.event_venues.kalshi.kalshi_risk.KalshiRiskConfig instead.
...
class KalshiRiskEngine:
    ...
    DEPRECATED: Use merid.event_venues.kalshi.kalshi_risk.KalshiRiskManager instead.
