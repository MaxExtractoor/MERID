    ...
    def __init__(self, config: Optional[ScannerConfig] = None):
        if config is None:
            config = ScannerConfig(
                ...
                enabled_symbols=[a.symbol for a in get_perp_universe()],
                min_profit_usd=10.0,
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logger.debug("Funding rate fetch failed for %s: %s", perp_symbol, _fr_exc)
...
_perp_spot_scanner_lock = threading.Lock()
