...
logger = get_logger("swarm.weekly_review_fixed")

def run_weekly_review_fixed(weeks_back: int = 1, output_file: str = "weekly_review_fixed.md"):
    """Run weekly review and save basic markdown report"""
    print("=" * 70)
    print("WEEKLY ROI REVIEW (FIXED)")
    print("=" * 70)
