    ...
    try:
        ...
        return {
            "swarm": {
                ...
                "participation_rate": stats.get("participation_rate", 0.0),
                "opinions_per_minute": stats.get("opinions_per_minute", 0.0),
                "consensus_per_minute": stats.get("consensus_per_minute", 0.0),
                "consensus_success_rate": stats.get("consensus_success_rate", 0.0),
                "avg_disagreement_rate": stats.get("avg_disagreement_rate", 0.0),
                "high_disagreement_count": stats.get("high_disagreement_count", 0),
...
async def get_swarm_health() -> Dict:
    ...
    try:
        ...
        critical_issues = [
            ...
            if "critical" in issue.lower() or "offline" in issue.lower()
        ]
