...
router = APIRouter(prefix="/api/v1/institutional", tags=["institutional"], dependencies=[Depends(get_current_session)]  # ZT6-01
)
...
async def get_config() -> Dict[str, Any]:
    ...
    try:
        ...
        # Exclude secret fields from config dump
        _SECRET_SUBSTRINGS = {"KEY", "SECRET", "TOKEN", "PASSWORD", "PEM", "PRIVATE", "CREDENTIAL", "AUTH"}
...
async def start_mesh() -> Dict[str, Any]:
    ...
    if os.environ.get("MERID_VALIDATION_MODE", "") == "1":
        return {
            "status": "skipped",
            "message": "Agent mesh disabled in VALIDATION_MODE",
        }
