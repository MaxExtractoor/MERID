...
router = APIRouter(prefix="/api/v1/simulation", tags=["simulation"], dependencies=[Depends(get_current_session)]  # ZT6-01
)
...
_sim_lock = threading.Lock()  # FPA-08: guards TOCTOU on _simulation_state["running"]
