...
from schemas.risk_schemas import RiskPreview, RiskLevel, RiskCategory, RiskFactor
from web.api.auth import get_current_session
from utils.logger import get_logger

router = APIRouter(prefix="/api/v1/schemas", tags=["schemas"], dependencies=[Depends(get_current_session)]  # ZT6-01
)
