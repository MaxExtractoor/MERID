    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "SLO data unavailable"}}
...
class OpinionFreshnessAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Store unavailable"}}
...
class SignalMetricsCacheStaleAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Cache unavailable"}}
...
class ExplanationCoverageLowAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            pct = coverage["pct"]
            # Only fire if there are opinions to evaluate
            ...
            return {
                ...
                "detail": {
                    ...
                    "with_explanation": coverage["with_explanation"],
                },
            }
        except Exception:
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Explainability data unavailable"}}
...
class ExplanationMissingCriticalAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            coverage = metrics["coverage"]
            total = coverage["total"]
            with_exp = coverage["with_explanation"]
            # Only fire if there are opinions but zero explanations
            firing = total >= 5 and with_exp == 0
            return {
                "firing": firing,
                "severity": self.severity,
                "name": self.name,
...
class CircuitBreakerOpenAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Breaker data unavailable"}}
...
class RiskKillSwitchAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Risk status unavailable"}}
...
class WSFeedDisconnectedAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "WS feed unavailable"}}
...
class NoDebateActivityAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Debate data unavailable"}}
...
class CalibrationDriftAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Calibration data unavailable"}}
...
class RewardContributionDriftAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Reward engine unavailable"}}
...
class StaleHypothesisAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Cognitive layer unavailable"}}
...
class BettingHealthAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Betting agent unavailable"}}
...
class LiveBettingLatencyAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Sports betting manager unavailable"}}
...
class OddsAnomalyAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Anomaly engine unavailable"}}
...
class SportsDebateLiftAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Sports debate coordinator unavailable"}}
...
class OddsCacheStalenessAlert(AlertRule):
    ...
    def evaluate(self) -> Dict[str, Any]:
        try:
            ...
            return {"firing": False, "severity": self.severity, "name": self.name,
                    "description": self.description, "detail": {"error": "Odds cache manager unavailable"}}
...
async def system_observability():
    ...
    signal_slo = {}
    try:
        signal_slo = _METRICS_CACHE.get("_slo", {})
    except Exception:
    ...
    try:
        store = get_prediction_consensus_store()
        store_metrics = store.get_store_metrics()
    except Exception:
    ...
    try:
        store = get_prediction_consensus_store()
        explainability = store.get_explainability_metrics(window_s=3600.0)
    except Exception:
    ...
    try:
        ...
        collaboration = debate_store.get_debate_metrics(window_s=3600.0)
    except Exception:
    ...
    try:
        debugger = get_reality_debugger()
        cognitive_health = debugger.get_cognitive_health(window_s=604800.0)
    except Exception:
    ...
    betting_health = {}
    try:
        bookie = get_bookie_agent()
        betting_health = bookie.get_betting_health()
    except Exception:
    ...
    try:
        sports_mgr = get_sports_betting_manager()
        sports_betting_health = sports_mgr.get_sports_health()
    except Exception:
...
async def consensus_store_metrics():
    ...
    try:
        store = get_prediction_consensus_store()
        return store.get_store_metrics()
