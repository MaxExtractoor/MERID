        ...
        if kalshi_markets:
            for market_id, market in kalshi_markets.items():
                ...
                markets.append({
                    ...
                    'end_date': datetime.fromtimestamp(market.resolution_date, tz=timezone.utc).isoformat() if market.resolution_date else None
                })
...
async def get_markets():
    ...
    markets = _markets_cache if _markets_cache else get_mock_markets()
    return {
        "markets": markets,
