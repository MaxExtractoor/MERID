...
@router.post("/mode")
async def set_trading_mode(request: ModeChangeRequest) -> Dict[str, Any]:
    """Change trading mode."""
    controller = get_trading_mode_controller()
...
@router.post("/limits")
async def set_autonomous_limits(request: AutonomousLimitsRequest) -> Dict[str, Any]:
...
async def record_spectator_trade(request: RecordTradeRequest) -> Dict[str, Any]:
...
async def close_spectator_trade(request: CloseTradeRequest) -> Dict[str, Any]:
