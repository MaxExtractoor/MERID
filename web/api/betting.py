...
router = APIRouter(prefix="/api/v1/betting", tags=["betting"], dependencies=[Depends(get_current_session)]  # ZT6-01
)
logger = get_logger("web.api.betting")

# Global bookie agent instance
_bookie_agent: Optional[BookieAgent] = None
_bookie_agent_lock = threading.Lock()
