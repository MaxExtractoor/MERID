...
export default function Wallet() {
  ...
  const { data: walletData, loading, error, refetch } = useApiData<WalletData>(
    API_ENDPOINTS.WALLET_BALANCES,
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50 flex items-center gap-3">
        ...
        <button type="button" className="ml-auto px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors" title="Connect">
          Connect
        </button>
      </div>
    </div>
