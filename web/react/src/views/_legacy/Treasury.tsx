...
export default function Treasury() {
  ...
  const { data: treasuryData, loading, error, refetch } = useApiData<TreasuryData>(
    API_ENDPOINTS.TREASURY_OVERVIEW,
      ...
      {selectedTab === 'proposals' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors" title="Create Proposal">
              Create Proposal
            </button>
          </div>
                ...
                {proposal.status === 'active' && (
                  <>
                    ...
                    <div className="flex gap-2">
                      <button type="button" className="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors" title="Vote For">
                        Vote For
                      </button>
                      <button type="button" className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors" title="Vote Against">
                        Vote Against
                      </button>
                    </div>
                  </>
