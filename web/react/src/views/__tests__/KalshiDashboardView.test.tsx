...
describe('KalshiDashboardView', () => {
  ...
  describe('Quick-Filter Tabs', () => {
    it('renders all 9 quick tabs including Favorites', () => {
      render(<KalshiDashboardView />);
  ...
  describe('Loading State', () => {
    it('shows loading indicator when data is loading', () => {
      ...
      render(<KalshiDashboardView />);
      // View renders skeleton loaders (not text) when loading — no market cards present
  ...
  describe('Edge/EV Display', () => {
    it('renders outcome price elements on market cards', () => {
      render(<KalshiDashboardView />);
      // Market cards render outcome prices (yes/no cents)
