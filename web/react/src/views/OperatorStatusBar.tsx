    ...
    <div className="flex flex-wrap items-center gap-3 px-4 py-2 bg-slate-900/80 border border-slate-800 rounded-xl">
      ...
      {summary?.system && (
        <div className="flex items-center gap-3 text-xs text-slate-500">
          <span>CPU {(typeof summary.system.cpu_percent === 'number' ? summary.system.cpu_percent.toFixed(0) : '0')}%</span>
          <span>MEM {(typeof summary.system.memory_percent === 'number' ? summary.system.memory_percent.toFixed(0) : '0')}%</span>
        </div>
      )}
