...
// BUG-32: Wrap with PanelErrorBoundary to prevent crashes from propagating
export default function VenueHealthGrid() {
  return (
    <PanelErrorBoundary panelName="VenueHealthGrid">
      <VenueHealthGridInner />
    </PanelErrorBoundary>
  );
}
