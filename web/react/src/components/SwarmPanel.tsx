    ...
    try {
      ...
      setSwarmData({
        agents: [
          {
            ...
            status: 'active',
            tasks_completed: 142,
            current_task: 'Analyzing BTC price trends',
          ...
          },
          {
            ...
            status: 'coordinating',
            tasks_completed: 156,
            current_task: 'Coordinating with Synthesizer on ETH signals',
            connections: ['agent-1', 'agent-3', 'agent-5'],
            confidence: 0.89,
          },
          {
            id: 'agent-3',
            ...
            status: 'active',
            tasks_completed: 98,
            current_task: 'Evaluating arbitrage opportunity risks',
            connections: ['agent-2', 'agent-4'],
            confidence: 0.91,
          },
          {
            id: 'agent-4',
          ...
          },
          {
            ...
            status: 'coordinating',
            tasks_completed: 45,
            current_task: 'Synthesizing multi-agent consensus on trade execution',
        ...
        tasks: [
          {
            id: 'task-1',
            title: 'Multi-Agent BTC Price Prediction',
            type: 'analysis',
            status: 'in_progress',
            assigned_agents: ['agent-1', 'agent-2', 'agent-5'],
            priority: 'high',
            progress: 67,
          ...
          {
            id: 'task-2',
            title: 'Coordinated Arbitrage Execution',
            type: 'trading',
            status: 'in_progress',
            assigned_agents: ['agent-2', 'agent-3', 'agent-5'],
            priority: 'high',
            progress: 45,
          ...
          {
            id: 'task-3',
            title: 'Portfolio Risk Assessment Consensus',
            type: 'research',
            status: 'pending',
            assigned_agents: ['agent-3', 'agent-4'],
            priority: 'medium',
            progress: 0,
