      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className={`rounded-lg border p-3 ${
          ...
          <div className="flex items-center gap-3 text-[10px] text-slate-500">
            <span>Daily PnL: <span className={(typeof data.kill_switch.daily_pnl === 'number' ? data.kill_switch.daily_pnl : 0) >= 0 ? 'text-green-400' : 'text-red-400'}>${(typeof data.kill_switch.daily_pnl === 'number' ? data.kill_switch.daily_pnl : 0).toFixed(2)}</span></span>
