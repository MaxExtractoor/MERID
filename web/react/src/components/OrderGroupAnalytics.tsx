...
export function OrderGroupAnalytics({
  ...
  const groupColors = [CHART_COLORS.BLUE, CHART_COLORS.GREEN, CHART_COLORS.AMBER, CHART_COLORS.RED, CHART_COLORS.PURPLE, CHART_COLORS.LIGHT_PURPLE];
          ...
          return (
            <div key={group.order_group_id} style={styles.statCard}>
              ...
              <div style={styles.statDetails}>
                <span>Peak: {(peak ?? 0).toFixed(1)}%</span>
                <span>
...
function getStatusColor(status: string): string {
  switch (status) {
    ...
    case 'canceled':
      return CHART_COLORS.GRAY_500;
    case 'pending':
      return CHART_COLORS.AMBER;
    default:
      return CHART_COLORS.GRAY_400;
  }
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  stats: {
    ...
    marginTop: '16px',
    paddingTop: '16px',
    borderTop: `1px solid ${CHART_COLORS.GRAY_200}`,
  },
  statCard: {
    padding: '10px',
