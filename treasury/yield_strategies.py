...
def get_strategy_competition() -> StrategyCompetition:
    ...
    if _strategy_competition is None:
        with _strategy_competition_lock:
            if _strategy_competition is None:
