...
# CRITICAL FIX (2026-08-02): Skip both catalog feed and startup phases to prevent hang
# The startup is hanging in complex initialization phases beyond catalog feed
