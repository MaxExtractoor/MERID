...
def _kalshi_v2_time_in_force(tif: str) -> str:
    """Kalshi Trade API v2 CreateOrderRequest.time_in_force (OpenAPI oneof)."""
    key = (tif or "gtc").strip().lower()
    return {
...
class KalshiRestClient:
    ...
    def _request(
        ...
        for attempt in range(self.MAX_RETRIES + 1):
            ...
            try:
                ...
                # T-065: Full jitter to prevent thundering herd
    ...
    def create_order(
        ...
        Args:
            ...
            time_in_force: legacy "gtc"/"ioc"/"fok" or API v2 snake_case enum
        ...
        order_data["time_in_force"] = _kalshi_v2_time_in_force(time_in_force)
