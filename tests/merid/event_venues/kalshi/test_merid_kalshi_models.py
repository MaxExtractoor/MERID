...
class TestKalshiConfig:
    ...
    def test_env_vars_loaded(self, monkeypatch):
        """Test environment variables loaded in __post_init__."""
        monkeypatch.setenv("KALSHI_EMAIL", "test@example.com")
        monkeypatch.setenv("KALSHI_PASSWORD", "secret")
        monkeypatch.setenv("KALSHI_API_KEY", "api_key_123")
        monkeypatch.setenv("KALSHI_PRIVATE_KEY_PATH", "/path/to/key")
