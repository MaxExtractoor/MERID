...
class TestTradingModeController:
    ...
    @pytest.fixture
    def controller(self, reset_trade_mode):
        # Default to paper mode for tests without explicit patch
        with patch.dict("os.environ", {"MERID_TRADE_MODE": "paper", "MERID_ALLOW_LIVE_TRADES": "true"}, clear=True):
    ...
    def test_initialization(self, controller):
        ...
        # HYBRID and AUTONOMOUS retired - always False
