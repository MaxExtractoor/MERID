...
class TestGlobalTradingMode:
    ...
    def test_mode_values(self):
        assert GlobalTradingMode.OFFLINE == "offline"
        assert GlobalTradingMode.SIM == "sim"
        assert GlobalTradingMode.PAPER == "paper"
        assert GlobalTradingMode.LIVE == "live"
        assert GlobalTradingMode.HYBRID == "hybrid"
...
class TestTradingRuntimeState:
    ...
    def test_state_defaults(self):
        ...
        assert state.mode == GlobalTradingMode.OFFLINE
...
class TestTradingRuntimeConfig:
    ...
    def test_initialization_default(self, config):
        assert config._state.mode == GlobalTradingMode.OFFLINE
