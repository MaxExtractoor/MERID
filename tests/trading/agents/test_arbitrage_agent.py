...
class TestArbitrageAgentExecute:
    ...
    @pytest.mark.asyncio
    async def test_execute_manual(self, clear_execution_gate):
    ...
    @pytest.mark.asyncio
    async def test_execute_auto(self, clear_execution_gate):
        """Test auto execution."""
        agent = ArbitrageAgent()
...
class TestArbitrageAgentStats:
    ...
    @pytest.mark.asyncio
    async def test_get_performance_stats_after_execution(self, clear_execution_gate):
