...
pytestmark = pytest.mark.skip(reason="analytics v1 deprecated - agent paths changed, v2 metrics system in development")
...
try:
    ...
    PredictionArbitrageAnalystAgent = None
    ArbitrageOpportunitySummary = None
    load_and_evaluate_csv = None
