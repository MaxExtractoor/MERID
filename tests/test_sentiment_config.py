"""test_sentiment_config.py — Unit tests for sentiment config, pure helpers,
_TagHistory, and _ScoreWindow.

No mocks for pure functions. No async. No redundant assertions.
"""
import hashlib
