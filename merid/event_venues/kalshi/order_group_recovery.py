...
class OrderGroupErrorClassifier:
    ...
    # Error patterns to codes — more-specific strings must precede any prefix they shadow
    ERROR_PATTERNS = {
        # CONTRACTS_LIMIT_EXCEEDED must precede "contracts_limit" (its prefix)
        ...
        # ORDER_PLACEMENT_BLOCKED — "blocked" is last (broadest prefix)
