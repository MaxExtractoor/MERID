...
Ensures complete coverage of all open Kalshi markets and alerts on gaps.
"""
...
logger = get_logger("merid.event_venues.kalshi.market_wiring.coverage")
...
class KalshiCoverageChecker:
    ...
    def _get_market_mappings(self) -> Dict[str, Any]:
        ...
        try:
            mappings = self._store.get_enabled_mappings()
            mapping_dict = {
    ...
    async def check_coverage(self) -> Dict[str, Any]:
        """Perform complete coverage check"""
        ...
        try:
            ...
            logger.info(
                ...
                f"enabled={report.enablement_percentage:.1f}%, "
