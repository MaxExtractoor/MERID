...
class PositionSizer:
    ...
    async def _volatility_based_sizing(self, position: Position, signal_strength: float,
        ...
        try:
            ...
            position_size = position_value / self.portfolio_value if self.portfolio_value > 0 else 0.0
            ...
            # Confidence score
            confidence_score = min(1.0, signal_strength * (1.0 / position.volatility)) if position.volatility > 0 else 0.0
    ...
    async def _risk_parity_sizing(self, position: Position, signal_strength: float,
        ...
        try:
            ...
            vol_signal = position.volatility * signal_strength
            if vol_signal <= 0:
                return None
    ...
    async def calculate_portfolio_risk(self, current_positions: Dict[str, float]) -> PortfolioRisk:
        ...
        try:
            ...
            # Risk budget usage
            risk_budget_used = total_risk / self.portfolio_value if self.portfolio_value > 0 else 0
