    ...
    def _load_profile(self) -> None:
        ...
        try:
            ...
            self._profile = Crypto15mProfile(
                ...
                momentum_fvg_rsi_bull_oversold=momentum_fvg_config.get('rsi_bull_oversold', 35.0),
                momentum_fvg_rsi_bull_overbought=momentum_fvg_config.get('rsi_bull_overbought', 75.0),
                momentum_fvg_rsi_bear_oversold=momentum_fvg_config.get('rsi_bear_oversold', 25.0),
                momentum_fvg_rsi_bear_overbought=momentum_fvg_config.get('rsi_bear_overbought', 65.0),
                ...
                guardrails_min_contract_price_cents=guardrails.get('min_contract_price_cents', 10),  # 2026-07-12: Default 10c to match YAML (lower bound maintained)
                guardrails_max_contract_price_cents=guardrails.get('max_contract_price_cents', 75),  # 2026-07-12: Default 75c to match YAML (expanded for current market conditions)
