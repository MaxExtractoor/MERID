...
def build_default_registry() -> InstrumentRegistry:
    ...
    # Crypto
    for merid, binance, coinbase, kraken, okx in [
        ("BTC-USD", "BTCUSDT", "BTC-USD", "XXBTZUSD", "BTC-USDT"),
        ("ETH-USD", "ETHUSDT", "ETH-USD", "XETHZUSD", "ETH-USDT"),
        ("SOL-USD", "SOLUSDT", "SOL-USD", "SOLUSD", "SOL-USDT"),
    ]:
        reg.register(Instrument(
            merid_symbol=merid,
            domain="crypto",
