...
class StrategyThresholds:
    min_edge_early: Decimal = Decimal("0.0125")  # ALIGNED TO 2026 MOLTBOOK RESEARCH: 1.25% base (BTC)
    min_edge_mid: Decimal = Decimal("0.0125")  # ALIGNED TO 2026 MOLTBOOK RESEARCH: 1.25% base (BTC)
