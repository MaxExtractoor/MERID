...
class PredictionRiskConfig:
    ...
    max_spread_cents: Decimal = Decimal("30")    # 2026-07-10: OPTIMIZED to 30c - harmonizes with 5c-85c canonical range (industry research: 3-8c typical, 30c quality filter)
